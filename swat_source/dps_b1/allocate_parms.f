...
!!      allocate (rcn(12,msub))
      ...
      allocate (dps_c(dps_nrbf))
      allocate (dps_w(dps_nrbf,dps_kout))
      allocate (dps_r(dps_nrbf))

      allocate (dps_tn_out_mass_yr(0:myr+1))
      allocate (dps_q_out_vol_yr(0:myr+1))
      allocate (dps_ctn_out_yr(0:myr+1))
      allocate(dps_z_yr(0:myr+1))
      
      !allocate (dps_u_raw_yr(0:myr+1))
      allocate (dps_u_raw_yr(0:myr+1,dps_kout))
      !allocate (dps_u_raw_yr2(0:myr+1))
      !allocate (dps_u_raw_yr3(0:myr+1))
      
      allocate (dps_u_yr(0:myr+1,dps_kout))
      !allocate (dps_u_yr2(0:myr+1))
      !allocate (dps_u_yr3(0:myr+1))
      
      allocate (dps_fac_yr(0:myr+1,dps_kout))
      !allocate (dps_fac_yr2(0:myr+1))
      !allocate (dps_fac_yr3(0:myr+1))
