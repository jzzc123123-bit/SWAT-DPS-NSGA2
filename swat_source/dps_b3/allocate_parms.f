...
!!      allocate (rcn(12,msub))
      !! DPS arrays
      allocate(dps_a(dps_kout))
      allocate(dps_c(dps_nrbf, dps_bdim))
      allocate(dps_w(dps_nrbf, dps_kout))
      allocate(dps_r(dps_nrbf, dps_bdim))

      allocate (dps_tn_out_mass_yr(0:myr+1))
      allocate (dps_q_out_vol_yr(0:myr+1))
      allocate (dps_ctn_out_yr(0:myr+1))
      
      allocate (dps_tn_allout_mass_yr(0:myr+1))
      allocate (dps_q_allout_vol_yr(0:myr+1))
      allocate (dps_ctn_allout_yr(0:myr+1))
      
      allocate(dps_z_yr(0:myr+1, dps_bdim))
      
      allocate(dps_u_raw_yr(0:myr+1, dps_kout))
      allocate(dps_u_yr(0:myr+1, dps_kout))
      allocate(dps_fac_yr(0:myr+1, dps_kout))

      allocate (dps_lorg_raw_yr(0:myr+1))
      allocate (dps_lno3_raw_yr(0:myr+1))
      allocate (dps_lnh3_raw_yr(0:myr+1))

      allocate (dps_lorg_base_yr(0:myr+1))
      allocate (dps_lno3_base_yr(0:myr+1))
      allocate (dps_lnh3_base_yr(0:myr+1))

      allocate (dps_lorg_target_yr(0:myr+1))
      allocate (dps_lno3_target_yr(0:myr+1))
      allocate (dps_lnh3_target_yr(0:myr+1))
      
      
      allocate (dps_lorg_raw_yr2(0:myr+1))
      allocate (dps_lno3_raw_yr2(0:myr+1))
      allocate (dps_lnh3_raw_yr2(0:myr+1))

      allocate (dps_lorg_base_yr2(0:myr+1))
      allocate (dps_lno3_base_yr2(0:myr+1))
      allocate (dps_lnh3_base_yr2(0:myr+1))

      allocate (dps_lorg_target_yr2(0:myr+1))
      allocate (dps_lno3_target_yr2(0:myr+1))
      allocate (dps_lnh3_target_yr2(0:myr+1))
      
      
      allocate (dps_lorg_raw_yr3(0:myr+1))
      allocate (dps_lno3_raw_yr3(0:myr+1))
      allocate (dps_lnh3_raw_yr3(0:myr+1))

      allocate (dps_lorg_base_yr3(0:myr+1))
      allocate (dps_lno3_base_yr3(0:myr+1))
      allocate (dps_lnh3_base_yr3(0:myr+1))

      allocate (dps_lorg_target_yr3(0:myr+1))
      allocate (dps_lno3_target_yr3(0:myr+1))
      allocate (dps_lnh3_target_yr3(0:myr+1))
...
!!    LID general
	...
	allocate(rspc_a(mhru))	
      ...
      dps_tn_out_mass_yr = 0.d0
      dps_q_out_vol_yr   = 0.d0
      dps_ctn_out_yr     = 0.d0
      
      dps_tn_allout_mass_yr = 0.d0
      dps_q_allout_vol_yr   = 0.d0
      dps_ctn_allout_yr     = 0.d0
      ...
      dps_lorg_raw_yr    = 0.d0
      dps_lno3_raw_yr    = 0.d0
      dps_lnh3_raw_yr    = 0.d0

      dps_lorg_base_yr   = 0.d0
      dps_lno3_base_yr   = 0.d0
      dps_lnh3_base_yr   = 0.d0

      dps_lorg_target_yr = 0.d0
      dps_lno3_target_yr = 0.d0
      dps_lnh3_target_yr = 0.d0
      
      
      dps_lorg_raw_yr2    = 0.d0
      dps_lno3_raw_yr2    = 0.d0
      dps_lnh3_raw_yr2    = 0.d0

      dps_lorg_base_yr2   = 0.d0
      dps_lno3_base_yr2   = 0.d0
      dps_lnh3_base_yr2   = 0.d0

      dps_lorg_target_yr2 = 0.d0
      dps_lno3_target_yr2 = 0.d0
      dps_lnh3_target_yr2 = 0.d0
      call zero0
      call zero1
      call zero2
      call zeroini
