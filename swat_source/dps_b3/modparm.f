...
!! septic variables for output.std
      ...
      ! command-line DPS parameters
      integer :: dps_from_cmd = 0
      integer :: dps_job_id = 0


!===== DPS annual control START =====
      integer :: dps_ready = 0
      integer :: dps_debug = 1
      integer :: dps_nrbf  = 7
      integer :: dps_kout  = 3
      integer :: dps_bdim = 3  !维度提取
      
!     状态提取
      integer :: dps_target_sub = 21

!     点源输入记录号(点源1号)
      integer :: dps_target_inum1 = 12
      
      !点源2号
      integer :: dps_target_inum12 = 1
      
      !点源3号
      integer :: dps_target_inum13 = 18
      
!     调试用：记录状态对应的reach号
      integer :: dps_state_reach

!     固定参数
      real*8 :: dps_smax = 3.d0
      real*8 :: dps_cstd = 2.d0

!     RBF 参数
      real*8, dimension(:), allocatable :: dps_a
      real*8, dimension(:,:), allocatable :: dps_w
      real*8, dimension(:,:), allocatable :: dps_c
      real*8, dimension(:,:), allocatable :: dps_r

!     状态与策略记录
      real*8, dimension(:), allocatable :: dps_tn_out_mass_yr
      real*8, dimension(:), allocatable :: dps_q_out_vol_yr
      real*8, dimension(:), allocatable :: dps_ctn_out_yr
      
      real*8, dimension(:), allocatable :: dps_tn_allout_mass_yr
      real*8, dimension(:), allocatable :: dps_q_allout_vol_yr
      real*8, dimension(:), allocatable :: dps_ctn_allout_yr
      
      real*8, dimension(:,:), allocatable :: dps_z_yr
      real*8, dimension(:,:), allocatable :: dps_u_raw_yr
      real*8, dimension(:,:), allocatable :: dps_u_yr
      real*8, dimension(:,:), allocatable :: dps_fac_yr

!     三部分原始年负荷、累计年均基准、目标年负荷 (kg/year)
      real*8, dimension(:), allocatable :: dps_lorg_raw_yr
      real*8, dimension(:), allocatable :: dps_lno3_raw_yr
      real*8, dimension(:), allocatable :: dps_lnh3_raw_yr

      real*8, dimension(:), allocatable :: dps_lorg_base_yr
      real*8, dimension(:), allocatable :: dps_lno3_base_yr
      real*8, dimension(:), allocatable :: dps_lnh3_base_yr

      real*8, dimension(:), allocatable :: dps_lorg_target_yr
      real*8, dimension(:), allocatable :: dps_lno3_target_yr
      real*8, dimension(:), allocatable :: dps_lnh3_target_yr
      
      
      !     三部分原始年负荷、累计年均基准、目标年负荷 (kg/year)(第2组)
      real*8, dimension(:), allocatable :: dps_lorg_raw_yr2
      real*8, dimension(:), allocatable :: dps_lno3_raw_yr2
      real*8, dimension(:), allocatable :: dps_lnh3_raw_yr2

      real*8, dimension(:), allocatable :: dps_lorg_base_yr2
      real*8, dimension(:), allocatable :: dps_lno3_base_yr2
      real*8, dimension(:), allocatable :: dps_lnh3_base_yr2

      real*8, dimension(:), allocatable :: dps_lorg_target_yr2
      real*8, dimension(:), allocatable :: dps_lno3_target_yr2
      real*8, dimension(:), allocatable :: dps_lnh3_target_yr2
      
      !三部分原始年负荷、累计年均基准、目标年负荷 (kg/year)(第3组)
      !后期如若做全流域点源负荷优化，可全部循环实现
      real*8, dimension(:), allocatable :: dps_lorg_raw_yr3
      real*8, dimension(:), allocatable :: dps_lno3_raw_yr3
      real*8, dimension(:), allocatable :: dps_lnh3_raw_yr3

      real*8, dimension(:), allocatable :: dps_lorg_base_yr3
      real*8, dimension(:), allocatable :: dps_lno3_base_yr3
      real*8, dimension(:), allocatable :: dps_lnh3_base_yr3

      real*8, dimension(:), allocatable :: dps_lorg_target_yr3
      real*8, dimension(:), allocatable :: dps_lno3_target_yr3
      real*8, dimension(:), allocatable :: dps_lnh3_target_yr3
!===== DPS annual control END =====
