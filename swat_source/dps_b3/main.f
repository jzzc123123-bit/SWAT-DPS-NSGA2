...
!! process input
      ...
      if (narg /= 67) then
        write(*,*) 'ERROR: DPS requires exactly 67 command-line arguments.'
        write(*,*) 'Order:'
        write(*,*) 'a(1:3), w(1:7,1:3), c(1:7,1:3), r(1:7,1:3), job_id'
        stop
      end if
...
!----- read w(irbf,kout), irbf = 1..7, kout = 1..3
      do irbf = 1, dps_nrbf
        do kout = 1, dps_kout
          call get_command_argument(iarg, arg)
...
!----- read c(irbf,jdim), irbf = 1..7, jdim = 1..3
      do irbf = 1, dps_nrbf
        do jdim = 1, dps_bdim
          call get_command_argument(iarg, arg)
...
!----- read r(irbf,jdim), irbf = 1..7, jdim = 1..3
      do irbf = 1, dps_nrbf
        do jdim = 1, dps_bdim
          call get_command_argument(iarg, arg)
